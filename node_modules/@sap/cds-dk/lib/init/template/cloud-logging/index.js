...
module.exports = class extends require('../../plugin') {
  ...
  async run() {
    const { hasTelemetry } = readProject()
    if (cds.cli.options['with-telemetry'] || hasTelemetry) {
